...
def get_city():
    ...
    while True:
        ...
        if city == "ch" or city == "chicago":
            ...
            return washington
        city = input(
            "Please choose between Chicago (CH), New York (NY), or Washington (WA)")
        city = city.lower()
...
def trip_duration(df):
    ...
    print("\nThe total travel time on 2017 through June was " +
          totalDays + " days \n")
    ...
    print("The average travel time on 2017 through June was " +
          averageDays + " days \n")
...
def popular_stations(df):
    ...
    start_station = df['Start Station'].value_counts().reset_index()[
        'index'][0]
    print(start_station)
...
def popular_trip(df):
    ...
    '''
    result = df[['Start Station', 'End Station']].groupby(
